...
A data.table containing the Seurat object's RNA counts or any other specified assay layer, with cell identities or barcodes as column names and feature names as first column. If write.path = TRUE, the data.table is also written to disk. If check.size = TRUE, will instead return the Seurat object.
