...
The Seurat object, an estimation of the Reference Matrix size in MB and a suggestion of the number of cells to downsample. If downsample = TRUE, the Seurat object will be downsampled to the suggested number of cells.
